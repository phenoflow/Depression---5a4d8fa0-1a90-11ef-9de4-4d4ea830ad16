...
codes = [{"code":"Eu34113","system":"readv2"},{"code":"Eu32y11","system":"readv2"},{"code":"Eu33z11","system":"readv2"},{"code":"Eu20400","system":"readv2"},{"code":"9kQ..00","system":"readv2"},{"code":"E2B0.00","system":"readv2"},{"code":"62T1.00","system":"readv2"},{"code":"Eu53012","system":"readv2"},{"code":"E2B1.00","system":"readv2"}];
REQUIRED_CODES = 1;
